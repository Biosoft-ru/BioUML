...
public class TestEModel extends TestCase
{
    public TestEModel( String name )
    {
        super(name);
    }
...
*/
    ...
    public void testAddVariable() throws Exception
    {
        ...
        DataCollection<Variable> variables = model.getVariables();
    ...
    {
        TestSuite suite = new TestSuite ( TestEModel.class );
        return suite;
    }
    ...
    public static void main( String[] args )
    {
        if ( args != null && args.length>0 && args[0].startsWith( "swing" ) )
            { junit.swingui.TestRunner.run( TestEModel.class ); }
        else

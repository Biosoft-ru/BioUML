 ...
 * for HeartModel diagram  at 2010.10.01 12:59:20
 */
import biouml.plugins.simulation.java.JavaBaseModel;

public class HeartModel_withoutArterials extends JavaBaseModel
{
...
public void calculateScalar(double[] x)
{
    Conductivity_Capillary = Conductivity_Capillary_0 + Debt_Capillary*x[1] + Humoral_Capillary*x[4];
    Elasticity_Venous = Elasticity_Venous_0 + Tone_Venous*x[4];
    Volume_Venous = Volume_Full - x[3] - Volume_Arterial;
    ...
    Oxygen_Delivery = BloodFlow_Capillary*(Oxygen_Arterial - x[2]);
    ...
    Pressure_Diastole = A_29*((x[3] - Volume_Ventricular_N)*(A_24*(x[3] - Volume_Ventricular_N) + Elasticity_Myocard));
...
public double[] dy_dt(double time, double[] x)
   {
      ...
      dydt[4] = +Reactivity_HeartCenter*(BR_HeartCenter*BloodFlow_Capillary/Volume_Arterial - Stress_HeartCenter*(Pressure_Arterial - Pressure_0) - x[4]);
      return dydt;
   }
...
public double[] getInitialValues()
   {
      ...
      if (!this.isInit)
      {
           ...
           x[1] = 3.0E-4; //  initial value of Oxygen_Debt
                        x[2] = 0.14; //  initial value of Oxygen_Venous
                x[3] = 156.0; //  initial value of Volume_Ventricular
               x[4] = 1.1; //  initial value of Humoral
...
public double[] extendResult(double time, double[] x)
   {
      ...
      calculateScalar(x);
      double[] yv7 = new double[53];
      yv7[0] = Pressure_Diastole;
      yv7[1] = Reactivity_HeartCenter;
      yv7[2] = Oxygen_UtilizationSpeed;
      yv7[3] = x[0];
      yv7[4] = Volume_Venous_N;
      yv7[5] = x[1];
      yv7[6] = Conductivity_Venous;
      yv7[7] = K_2;
      yv7[8] = Volume_Arterial;
      yv7[9] = Conductivity_Capillary_0;
      yv7[10] = Debt_Capillary;
      yv7[11] = A_7;
      yv7[12] = Stress_HeartCenter;
      yv7[13] = Duration_Sistole;
      yv7[14] = S_3;
      yv7[15] = Tone_Venous;
      yv7[16] = Humoral_Diastole;
      yv7[17] = Conductivity_Capillary;
      yv7[18] = Elasticity_Venous;
      yv7[19] = Oxygen_Need;
      yv7[20] = x[2];
      yv7[21] = Pressure_0;
      yv7[22] = Elasticity_Venous_0;
      yv7[23] = Elasticity_Myocard;
      yv7[24] = Volume_Ventricular_Diastole;
      yv7[25] = Oxygen_Arterial;
      yv7[26] = K_1;
      yv7[27] = x[3];
      yv7[28] = Conductivity_Arterial;
      yv7[29] = S_2;
      yv7[30] = Pressure_Arterial;
      yv7[31] = Stage_Sistole;
      yv7[32] = Volume_Full;
      yv7[33] = x[4];
      yv7[34] = BloodFlow_VentricularToArterial;
      yv7[35] = A_10;
      yv7[36] = Pressure_Venous;
      yv7[37] = BR_HeartCenter;
      yv7[38] = Conductivity_Venous_0;
      yv7[39] = time;
      yv7[40] = S_1;
      yv7[41] = Humoral_Capillary;
      yv7[42] = Oxygen_Delivery;
      yv7[43] = A_24;
      yv7[44] = BloodFlow_Capillary;
      yv7[45] = Debt_Venous;
      yv7[46] = Volume_Venous;
      yv7[47] = BloodFlow_VenousToVentricular;
      yv7[48] = Volume_Ventricular_N;
      yv7[49] = A_18;
      yv7[50] = A_29;
      yv7[51] = Pressure_Sistole;
      yv7[52] = A_6;
      return yv7;
   }
...
public double[] checkEvent(double time, double[] x)
   {
      this.time = time;
      calculateScalar(x);
      double [] flagsv8  = new double[2];
      flagsv8[0] = (x[3] < (1 - K_1)*Volume_Ventricular_Diastole + K_2) ? +1 : -1; // event: event0;
      flagsv8[1] = (x[0] > 1.0/x[4] - Duration_Sistole) ? +1 : -1; // event: event1;
      return flagsv8;
   }
   
   @Override
public void processEvent(int v9)
   {
      if (v9 == 0)
      {  // event0

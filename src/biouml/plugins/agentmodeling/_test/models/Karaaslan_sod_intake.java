...
public class Karaaslan_sod_intake extends JavaBaseModel
{
 ...
 */
    private void __internalVarInitFunc_0(double time, double[] x)
    {
        ...
        rsna = N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281)));
        alpha_map = 0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15));
        alpha_rap = 1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281));
        R_tp = K_bar/x[6]*eps_aum + R_bv;
        Fi_vr = ((7.436*(4.5602271 + 2.4312171/(1 + Math.exp(-(x[4] - 18.112781)*0.4737))) - 30.18)*eps_aum - 0.2787*Math.exp(Fi_co*0.2281))/((8*R_bv + K_bar/x[6]*eps_aum)/31);
        R_ba = K_bar/x[6];
        R_a = K_bar/x[6]*eps_aum;
        vas_f = 11.312*Math.exp(-Fi_co*0.4799)/100000;
        vas_d = x[6]*K_vd;
        R_vr = (8*R_bv + K_bar/x[6]*eps_aum)/31;
        P_mf = (7.436*(4.5602271 + 2.4312171/(1 + Math.exp(-(x[4] - 18.112781)*0.4737))) - 30.18)*eps_aum;
        alpha_auto = 3.079*Math.exp(-P_ma*0.011);
        alpha_chemo = 0.25*(3.079*Math.exp(-P_ma*0.011));
        V_b = 4.5602271 + 2.4312171/(1 + Math.exp(-(x[4] - 18.112781)*0.4737));
        Fi_u = ((P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf) - (0.025 - 0.0011/((0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log10(C_al))/0.88)))*(0.37 + 0.8/(1 + Math.exp(0.6 - 3.7*Math.log10(4*x[2]))))) + 0.8*((P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf));
        Fi_win = 0.0081/(1 + 1.822*Math.pow((4*x[2]), (-1.607))) - 0.0053;
        Fi_t_wreab = 0.025 - 0.0011/((0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log10(C_al))/0.88)))*(0.37 + 0.8/(1 + Math.exp(0.6 - 3.7*Math.log10((4*x[2])))))) + 0.8*((P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf);
        mu_al = 0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log10(C_al))/0.88));
        mu_adh = 0.37 + 0.8/(1 + Math.exp(0.6 - 3.7*Math.log10(4*x[2])));
        Fi_gfilt = (P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf;
        P_f = P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go;
        P_gh = P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))));
        C_adh = 4*x[2];
        N_adhs = (x[1]/x[4] - 140 + eps_aum - (0.2*(0.2787*Math.exp(Fi_co*0.2281)) - 7.0E-4*x[7]))/3;
        delta_ra = 0.2*(0.2787*Math.exp(Fi_co*0.2281)) - 7.0E-4*x[7];
        ksi_at = 0.4 + 2.4/(1 + Math.exp((2.82 - 1.5*Math.log10(20*x[0]))/0.8));
        N_als = (5/(0.003525*(x[1]/x[4])) - 9)*1*(0.4 + 2.4/(1 + Math.exp((2.82 - 1.5*Math.log10(20*x[0]))/0.8)));
        ksi_k_sod = 5/(0.003525*(x[1]/x[4])) - 9;
        ksi_map = 1;
        Fi_rb = P_ma/R_r;
        C_sod = x[1]/x[4];
        C_K = 5;
        C_at = 20*x[0];
        R_aa = 31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))));
        beta_rsna = 1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1;
        R_ea = 51.66*(0.9432 + 0.1363/(0.2069 + Math.exp(3.108 - 1.785*Math.log10(20*x[0]))));
        N_rs = (0.2262 + 28.04/(11.56 + Math.exp((Fi_md_sod - 1.667)/0.6056)))*(1.89 - 2.056/(1.358 + Math.exp(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 0.8667)));
        nu_md_sod = 0.2262 + 28.04/(11.56 + Math.exp((Fi_md_sod - 1.667)/0.6056));
        nu_rsna = 1.89 - 2.056/(1.358 + Math.exp(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 0.8667));
    }
    private void __internalVarInitFunc_1(double time, double[] x)
    {
        sigma_tgf = 0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)));
        Fi_pt_sodreab = (P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf*(x[1]/x[4])*(n_eta_pt*((0.8 + 0.3/(1 + Math.exp(1 + ((P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf*(x[1]/x[4]) - 14)/138)))/0.882)*(0.95 + 0.12/(1 + Math.exp(2.6 - 1.8*Math.log(20*x[0])/Math.log(10))))*((0.5 + 0.7/(1 + Math.exp((1 - N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))))/2.18)))/0.853));
        eta_pt_sodreab = n_eta_pt*((0.8 + 0.3/(1 + Math.exp(1 + ((P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf*(x[1]/x[4]) - 14)/138)))/0.882)*(0.95 + 0.12/(1 + Math.exp(2.6 - 1.8*Math.log(20*x[0])/Math.log(10))))*((0.5 + 0.7/(1 + Math.exp((1 - N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))))/2.18)))/0.853);
        gamma_filsod = (0.8 + 0.3/(1 + Math.exp(1 + ((P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf*(x[1]/x[4]) - 14)/138)))/0.882;
        gamma_at = 0.95 + 0.12/(1 + Math.exp(2.6 - 1.8*Math.log(20*x[0])/Math.log(10)));
        gamma_rsna = (0.5 + 0.7/(1 + Math.exp((1 - N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))))/2.18)))/0.853;
        Fi_filsod = (P_ma - P_ma/R_r*(31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*(0.2787*Math.exp(Fi_co*0.2281))) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617))))) - P_B - P_go)*C_gcf*(x[1]/x[4]);
        Fi_u_sod = Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88))))*(n_eta_cd*(0.82 + 0.39/(1 + Math.exp((Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - 1.6)/2)))*(-0.1*(7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762))) + 1.1199));
        Fi_cd_sodreab = Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88))))*(n_eta_cd*(0.82 + 0.39/(1 + Math.exp((Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - 1.6)/2)))*(-0.1*(7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762))) + 1.1199));
        eta_cd_sodreab = n_eta_cd*(0.82 + 0.39/(1 + Math.exp((Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - 1.6)/2)))*(-0.1*(7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762))) + 1.1199);
        lambda_dt = 0.82 + 0.39/(1 + Math.exp((Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - 1.6)/2));
        lambda_anp = -0.1*(7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762))) + 1.1199;
        Fi_dt_sod = Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88))));
        Fi_dt_sodreab = Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88))));
        eta_dt_sodreab = n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)));
        psi_al = 0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88));
        C_anp = 7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762));
...
if (time < 3000) {
    ...
    piecewise_1 = 0.02;
        ...
        Fi_s = piecewise_1 - (Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88))))*(n_eta_cd*(0.82 + 0.39/(1 + Math.exp((Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - 1.6)/2)))*(-0.1*(7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762))) + 1.1199)));
    }
 ...
 */
    ...
    public double[] solveAlgebraic(double[] z)
    {
        ...
        result[0] = Fi_co*(K_bar/x[6]*eps_aum + R_bv) - P_ma;

        result[1] = ((7.436*(4.5602271 + 2.4312171/(1 + Math.exp(-(x[4] - 18.112781)*0.4737))) - 30.18)*eps_aum - 0.2787*Math.exp(Fi_co*0.2281))/((8*R_bv + K_bar/x[6]*eps_aum)/31) - Fi_co;

        result[2] = 0.25*(3.079*Math.exp(-P_ma*0.011)) + x[5] - eps_aum;

        result[3] = x[3]*85 - C_al;

        result[4] = 31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))) + 51.66*(0.9432 + 0.1363/(0.2069 + Math.exp(3.108 - 1.785*Math.log10(20*x[0])))) - R_r;

        result[5] = (P_ma - P_ma/R_r*31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))) - P_B - P_go)*C_gcf*(x[1]/x[4]) - (P_ma - P_ma/R_r*31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))) - P_B - P_go)*C_gcf*(x[1]/x[4])*(n_eta_pt*((0.8 + 0.3/(1 + Math.exp(1 + ((P_ma - P_ma/R_r*31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))) - P_B - P_go)*C_gcf*(x[1]/x[4]) - 14)/138)))/0.882)*(0.95 + 0.12/(1 + Math.exp(2.6 - 1.8*Math.log(20*x[0])/Math.log(10))))*((0.5 + 0.7/(1 + Math.exp((1 - N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)))/2.18)))/0.853)) - Fi_md_sod;
        return result;
    }
...
if (time < 3000) {
    ...
    piecewise_3 = 0.02;
        ...
        result[1] = +piecewise_3 - (Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88))))*(n_eta_cd*(0.82 + 0.39/(1 + Math.exp((Fi_md_sod - Fi_md_sod*(n_eps_dt*(0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log(C_al)/Math.log(10))/0.88)))) - 1.6)/2)))*(-0.1*(7.427 - 6.554/(1 + Math.exp(0.2787*Math.exp(Fi_co*0.2281) - 3.762))) + 1.1199)));
        result[2] = +((x[1]/x[4] - 140 + eps_aum - 0.2*0.2787*Math.exp(Fi_co*0.2281) - 7.0E-4*x[7])/3 - x[2])/T_adh;
        result[3] = +((5/(0.003525*x[1]/x[4]) - 9)*1*(0.4 + 2.4/(1 + Math.exp((2.82 - 1.5*Math.log10(20*x[0]))/0.8))) - x[3])/T_al;
        result[4] = +0.0081/(1 + 1.822*Math.pow((4*x[2]), (-1.607))) - 0.0053 - ((P_ma - P_ma/R_r*31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))) - P_B - P_go)*C_gcf - (0.025 - 0.0011/((0.17 + 0.94/(1 + Math.exp((0.48 - 1.2*Math.log10(C_al))/0.88)))*(0.37 + 0.8/(1 + Math.exp(0.6 - 3.7*Math.log10((4*x[2])))))) + 0.8*(P_ma - P_ma/R_r*31.67*(1.5*(N_rsna*(0.5 + 1.1/(1 + Math.exp((P_ma - 100)/15)))*(1 - 0.0080*0.2787*Math.exp(Fi_co*0.2281)) - 1) + 1)*(0.3408 + 3.449/(3.88 + Math.exp((Fi_md_sod - 3.859)/(-0.9617)))) - P_B - P_go)*C_gcf));
        result[5] = -5.0025E-5*(x[5] - 1);

...
import biouml.plugins.antimony.lex.AntimonyLexer;

/**
 * JEditorPane version with implemented undo\redo actons (with ctrl-z, ctrl-y
 * key combinations) and numbered lines
 * 
 * @author ilya
 *
 */
public class AntimonyEditorPane extends JEditorPane
{
    ...
    public AntimonyEditorPane()
    {
        super();
        setEditorKit(new StyledEditorKit());
        HighlightedDocument document = new HighlightedDocument();
        document.setHighlightStyle(AntimonyLexer.class);

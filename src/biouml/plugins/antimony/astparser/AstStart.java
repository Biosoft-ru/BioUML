...
import biouml.plugins.antimony.astparser.AstModel.ModelType;
...
public class AstStart extends SimpleNode
{
    ...
    public AstStart(AntimonyParser p, int id)
    {
        super(p, id);
    }
    ...
    {
        AstModel model = new AstModel(AntimonyParser.JJTMODEL);

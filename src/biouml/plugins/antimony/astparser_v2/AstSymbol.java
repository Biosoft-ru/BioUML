...
public class AstSymbol extends SimpleNode
{
    ...
    public static final String REACTION_UNKNOWN_MODIFIER = "modulation";//"Unknown modifier";
    public static final String REACTION_INHIBITOR = "inhibition";//"Inhibitor";
    public static final String REACTION_ACTIVATOR = "catalysis";//"Activator";
    ...
    public static final String FUNCTION_RETURN_ASSIGNMENT = "Function return assignment";
    ...
    public AstSymbol(AntimonyNotationParser p, int id)
    {
        super(p, id);
    }

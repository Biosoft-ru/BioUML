 ...
 * @author ilya
 */
public class AntimonyToken extends Token
{
    public final static int RESERVED_WORD_MODEL = 0x121;
    public final static int RESERVED_WORD_VAR = 0x122;
    public final static int RESERVED_WORD_AT = 0x123;
    public final static int RESERVED_WORD_AFTER = 0x124;
    public final static int RESERVED_WORD_IS = 0x125;
    public final static int RESERVED_WORD_IN = 0x126;
    public final static int RESERVED_WORD_UNIT = 0x127;
    public final static int RESERVED_WORD_SPECIES = 0x128;
    public final static int RESERVED_WORD_COMPARTMENT = 0x129;
    public final static int RESERVED_WORD_CONST = 0x130;
    public final static int RESERVED_WORD_IMPORT = 0x131;
    public final static int RESERVED_WORD_DELETE = 0x132;
    public final static int RESERVED_WORD_FUNCTION = 0x133;
    public final static int RESERVED_WORD_END = 0x134;
    public final static int RESERVED_WORD_GENE = 0x135;
    public final static int RESERVED_WORD_HAS = 0x136;
    public final static int RESERVED_WORD_ASSERT = 0x137;
    public final static int RESERVED_WORD_ELSE = 0x138;
    public final static int RESERVED_WORD_SUBTYPE = 0x139;
    public final static int RESERVED_WORD_SUBSTANCEONLY = 0x140;
    ...
    public final static int ATOM_PI = 0x136;
    public final static int ATOM_AVOGADRO = 0x137;
    public final static int ATOM_INFINITY = 0x138;
    public final static int ATOM_EXPONENTIALE = 0x139;
    ...
    public final static int OPERATOR_DIFF = 0x548;
    ...
    public AntimonyToken(int ID, String contents, int lineNumber, int charBegin, int charEnd)
    {
        this(ID, contents, lineNumber, charBegin, charEnd, Token.UNDEFINED_STATE);
    }

    public AntimonyToken(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state)
    {
        this.ID = ID;

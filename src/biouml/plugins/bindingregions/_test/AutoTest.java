...
public class AutoTest extends TestCase
{
    ...
    public static Test suite()
    {
        ...
        suite.addTestSuite(TestSNPAnalyses.class);
        suite.addTestSuite(TestFiveSiteModels.class);
        suite.addTestSuite(TestBindingRegionAnalyses.class);
        suite.addTestSuite(TestGatheringGenomeStatistics.class);

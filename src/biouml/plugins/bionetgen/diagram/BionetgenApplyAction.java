...
public class BionetgenApplyAction extends BackgroundDynamicAction
{
    public BionetgenApplyAction()
    {
    ...
    {
        return object instanceof Diagram && BionetgenUtils.checkDiagramType( (Diagram)object );
    }
        ...
        return new AbstractJobControl( log )
        {
            ...
            protected void doRun() throws JobControlException
            {
                try
                {
                    ...
                    Diagram changedDiagram = bionetgen.generateDiagram( BionetgenUtils.getBionetgenAttr( diagram ) );
                    ...
                    Object listener = diagram.getAttributes().getValue( BionetgenDiagramListener.LISTENER_ATTR );
                    if( listener instanceof BionetgenDiagramListener )
                        ( (BionetgenDiagramListener)listener ).bionetgen = bionetgen;
                }
                catch( Exception e )
                {
            ...
            private void copyDiagramElement(Diagram diagram, DiagramElement de)
            {

...
public class SequenceFeatureBeanInfo extends ConceptBeanInfo
{
    public SequenceFeatureBeanInfo()
    {
        this(SequenceFeature.class, "SEQUENCEFEATURE" );
    }

    protected SequenceFeatureBeanInfo(Class beanClass, String key)
    {
        super(beanClass, key);
    }
    ...
    public void initProperties() throws Exception
    {
        ...
        add(index, pde,
                getResourceString("PN_SEQUENCEFEATURE_LOCATION"),
                getResourceString("PD_SEQUENCEFEATURE_LOCATION"));
        
        pde = new PropertyDescriptorEx("featureType", beanClass);
        HtmlPropertyInspector.setDisplayName(pde, "TP");
        add(index+1, pde,
                getResourceString("PN_SEQUENCEFEATURE_TYPE"),
                getResourceString("PD_SEQUENCEFEATURE_TYPE"));

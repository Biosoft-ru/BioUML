...
public class Epileptor2CellularModelProperties extends Options implements BrainModelProperties
{
	/*
	 * Epileptor-2 cellular model
	 * 
	 * cell dynamic:
    ...
    public Epileptor2CellularModelProperties()
    {
    }

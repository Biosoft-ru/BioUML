 ...
 *
 */
public class ChipMunkAnalysisParametersBeanInfo extends BeanInfoEx2<ChipMunkAnalysisParameters>
{
    public ChipMunkAnalysisParametersBeanInfo()
    {
        super( ChipMunkAnalysisParameters.class );
    }

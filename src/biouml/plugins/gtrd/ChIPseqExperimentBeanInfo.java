...
public class ChIPseqExperimentBeanInfo extends BeanInfoEx 
{
	public ChIPseqExperimentBeanInfo()
	{
		super(ChIPseqExperiment.class, MessageBundle.class.getName());
		beanDescriptor.setDisplayName("ChIP-seq experiment");
		beanDescriptor.setShortDescription("ChIP-seq experiment");
	}
	protected void initProperties() throws Exception
    {
        ...
        pde = new PropertyDescriptorEx("macs2", beanClass, "getMacsPeaks", null);
        add(pde, "MACS2 Peaks", "MACS2 Peaks");
        
        pde = new PropertyDescriptorEx("sissrs", beanClass, "getSissrsPeaks", null);
        add(pde, "SISSRS Peaks", "SISSRS Peaks");

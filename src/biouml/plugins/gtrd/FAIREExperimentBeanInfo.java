...
public class FAIREExperimentBeanInfo extends BeanInfoEx 
{
	
	public FAIREExperimentBeanInfo()
	{
		super(MNaseExperiment.class, MessageBundle.class.getName());
        beanDescriptor.setDisplayName("FAIRE-seq experiment");
        beanDescriptor.setShortDescription("FAIRE-seq experiment");
	}
    @Override

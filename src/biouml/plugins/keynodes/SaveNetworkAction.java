...
public class SaveNetworkAction extends BackgroundDynamicAction
{
    @Override
    ...
    public Object getProperties(Object model, List<DataElement> selectedItems)
    {
        ...
        DataElementPath defaultPath = DataElementPath.create(sourcePath.optParentCollection(), sourcePath.getName() + " network");

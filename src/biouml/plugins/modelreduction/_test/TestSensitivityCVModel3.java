...
public class TestSensitivityCVModel3 extends AbstractBioUMLTest
{
    public TestSensitivityCVModel3(String name)
    {
        super(name);
    }
    ...
    {
        TestSuite suite = new TestSuite(TestSensitivityCVModel3.class);
        return suite;
    }
    ...
    public void test() throws Exception
    {
        ...
        analysis.getParameters().setAbsoluteTolerance(0.001);
...
//        inputSet1.setVariableNames(new String[] {VariableSet.CONSTANT_PARAMETERS});//VariableSet.CONSTANT_PARAMETERS});
        ...
        inputSet2.setVariableNames(new String[]{VariableSet.CONSTANT_PARAMETERS});//.CONSTANT_PARAMETERS});

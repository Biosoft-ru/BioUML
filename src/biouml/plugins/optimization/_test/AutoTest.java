...
//        suite.addTest(TestTimeCourseOptimization.suite());
//        suite.addTest(TestSteadyStateOptimization.suite());
//        suite.addTest(TestConstraintOptimization.suite());
//        suite.addTest(TestRelativeDataOptimization.suite());

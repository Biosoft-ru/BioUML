...
public class TestSteadyStateOptimization extends AbstractBioUMLTest
{
    public TestSteadyStateOptimization(String name)
    {
        super(name);
    }
    ...
    {
        TestSuite suite = new TestSuite(TestSteadyStateOptimization.class);
        return suite;
    }
    ...
    public void testSres() throws Exception
    {
        ...
        OptimizationProblem problem = TestUtils.createSteadyStateProblem();
    ...
    public void testGoldfeld() throws Exception
    {
        ...
        OptimizationProblem problem = TestUtils.createSteadyStateProblem(TestUtils.OptimizationType.LOCAL);
        method.setOptimizationProblem(problem);

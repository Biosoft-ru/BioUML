...
public class ClientGenericFileDataCollection extends ClientDataCollection<DataElement>
        implements FolderCollection, FileBasedCollection<DataElement>
{
    /** Indicates that ClientGenericFileDataCollection can get direct access to files without sending them via internet. */
    public static final String FILE_DIRECT_ACCESS = AccessProtocol.SERVER_PREFIX + "file-direct-access";

	public ClientGenericFileDataCollection(DataCollection<?> parent, Properties properties) throws Exception 
	{
    ...
    public File getChildFile(String name)
    {
        try
        {
            return TempFiles.file( "client_generic_file_" + name );
        }
        catch( IOException e )
        {
            throw ExceptionRegistry.translateException( e );

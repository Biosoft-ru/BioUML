...
public class BIOMD404_2 extends JavaBaseModel
{
    ...
    {
        double[] x_values = this.x_values;
        rate_motor_r4 = function_4_motor_r4(x_values[3]/cell, x_values[4]/cell, x_values[5]/cell, alpha, cell, ka, kappa);
        rate_motor_r3 = function_4_motor_r3(x_values[2]/cell, x_values[3]/cell, x_values[5]/cell, alpha, cell, ka, kappa);
        rate_motor_r2 = function_4_motor_r2(x_values[1]/cell, x_values[2]/cell, x_values[5]/cell, alpha, cell, ka, kappa);
        rate_motor_r1 = function_4_motor_r1(x_values[0]/cell, x_values[1]/cell, x_values[5]/cell, cell, ka, kappa);
    }
    ...
    {
         return ka*(MYpYp*Yp - 3.0*alpha*alpha*kappa/2.0*MYpYpYp);
    }
    ...
    {
         return ka*(MYpYpYp*Yp - 4.0*alpha*alpha*alpha*kappa*MYpYpYpYp);
    }

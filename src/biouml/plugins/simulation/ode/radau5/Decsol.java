...
-----------------------------------------------------------------------*/
    ...
    if (n != 1) {
        ...
        for (k = 0; k < nm1; k++) {
            ...
            m = k;
            for (int i = kp1; i < n; i++) {
                if ((Math.abs(AR[i][k]) + Math.abs(AI[i][k])) >
                    (Math.abs(AR[m][k]) + Math.abs(AI[m][k])))
                    m = i;
            }
            ip[k] = m;
            tr = AR[m][k];
   ...
   protected static void solc(int n, double[][] AR, double[][] AI, double[] br,
    double[] bi, int[] ip)
   {
...
-----------------------------------------------------------------------*/
   ...
   protected static void solhc(int n, double[][] AR, double[][] AI, int lb,
    ...
    if (n != 1) {
        ...
        if (lb != 0) {
            for (int k = 0; k < nm1; k++) {
                ...
                br[k] = tr;
                bi[k] = ti;
                for (int i = kp1; i < Math.min(n, lb+k+1); i++) {
                    prodr = AR[i][k]*tr - AI[i][k]*ti;
                    prodi = AI[i][k]*tr + AR[i][k]*ti;
                    br[i] += prodr;
                    bi[i] += prodi;
...
-----------------------------------------------------------------------*/
   ...
   protected static void solbc(int n, double[][] AR, double[][] AI, int ml, int mu,
    double[] br, double[] bi, int[] ip)
   {

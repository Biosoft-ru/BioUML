...
public class SBMLTest extends AbstractBioUMLTest
{
    /** Standart JUnit constructor */
    public SBMLTest(String name)
    {
        super(name);
    ...
    {
        TestSuite suite = new TestSuite(SBMLTest.class.getName());
        suite.addTest(new SBMLTest("testSBML"));
        return suite;
    }

    static String DEFAULT_TEST_DIR = "../data_resources/SBML tests/cases/";
    static String DEFAULT_OUT_DIR = "../data_resources/SBML tests/cases/results/";
    ...
    {
        SemanticSimulatorTest semanticSimulatorTest = new SemanticSimulatorTest();

...
public class AutoTest extends TestCase
{
    ...
    public static Test suite()
    {
        ...
        suite.addTestSuite(ReactionCreationTest.class);
        suite.addTestSuite(TestPathwaySemanticController.class);
        suite.addTestSuite(ArrowIntersectionTest.class);
        suite.addTestSuite(TestCompositePreprocessor.class);
        return suite;
    }

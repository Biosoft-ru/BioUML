...
public class Q2ValuesCommand extends TagCommandSupport<SimulationResult>
{
    protected static final Logger log = Logger.getLogger(VariablesCommand.class.getName());

    protected VariablesCommand varCommand;

    public Q2ValuesCommand(TagEntryTransformer<SimulationResult> transformer, VariablesCommand varCommand)
    {
        super("Q2", transformer);
    ...
    public String getTaggedValue()
    {
        ...
        {
            // Write time
            result.append("Q2    " + times[timeSliceNumber] + "\t");

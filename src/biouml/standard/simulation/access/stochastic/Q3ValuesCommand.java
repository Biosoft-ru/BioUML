...
public class Q3ValuesCommand extends TagCommandSupport<SimulationResult>
{
    protected static final Logger log = Logger.getLogger(VariablesCommand.class.getName());

    protected VariablesCommand varCommand;

    public Q3ValuesCommand(TagEntryTransformer<SimulationResult> transformer, VariablesCommand varCommand)
    {
        super("Q3", transformer);
    ...
    public String getTaggedValue()
    {
        ...
        {
            // Write time
            result.append("Q3    " + times[timeSliceNumber] + "\t");

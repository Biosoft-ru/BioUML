...
public class AutoTest extends TestCase
{
    ...
    public static Test suite()
    {
        ...
        suite.addTestSuite(TrackCoverageAnalysisTest.class);
        suite.addTestSuite(FrequencyMatrixTest.class);
        suite.addTestSuite(WeightMatrixModelTest.class);
        suite.addTestSuite( TestSiteSearch.class );
        suite.addTestSuite( TestGeneSetToTrack.class );
        return suite;
    }

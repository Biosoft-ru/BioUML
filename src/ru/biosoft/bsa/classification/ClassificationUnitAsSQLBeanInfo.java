...
public class ClassificationUnitAsSQLBeanInfo extends BeanInfoEx
{
    public ClassificationUnitAsSQLBeanInfo()
    {
        super(ClassificationUnitAsSQL.class, MessageBundle.class.getName());

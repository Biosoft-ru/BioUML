...
def __main__():
    ...
    parser.add_option( '', '--seed_mismatches', dest='seed_mismatches')
    parser.add_option( '', '--seed_length', dest='seed_length')
    parser.add_option( '', '--seed_interval_function', dest='seed_interval_function')
    parser.add_option( '', '--seed_extension_attempts', dest='seed_extension_attempts')
    parser.add_option( '', '--reseed_attempts', dest='reseed_attempts')
    parser.add_option( '', '--report_all', dest='report_all', action="store_true")
    ...
    if options.settings == 'preSet':
        ...
        if options.preset_alignment:
            ...
            opts += ' -N ' + options.seed_mismatches
            opts += ' -L ' + options.seed_length
            opts += ' -i ' + options.seed_interval_function
            opts += ' -D ' + options.seed_extension_attempts
            opts += ' -R ' + options.reseed_attempts 
        if options.norc:
            opts += ' --norc'

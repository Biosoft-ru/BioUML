...
var resources = {
    ...
    vpDescriptionNothingSelected: "Выберите элемент структуры, чтобы просмотреть описание",
    ...
    vpDescriptionPrompt: "<span style='color:gray'>Оставьте свой комментарий здесь - нажмите кнопку «Редактировать» выше</span>",
    ...
    vpGraphSearchTitle: "Графический поиск",
    ...
    vpGraphSearchHeaderLinkedFrom: "Ссылка",
